 ...
 * Copyright (c) 2009-2011 by SAUS, Inc. All Rights Reserved.
...
//@interface SAUSObject : NSObject
//@end

@interface SAUSObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SAUSObject class]])
		{
			for (NSString *key in [[(SAUSObject*)o modules] allKeys])
			{
